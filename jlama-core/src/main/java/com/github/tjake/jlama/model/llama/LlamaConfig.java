...
public class LlamaConfig extends Config {
    ...
    public LlamaConfig( @JsonProperty("max_position_embeddings") int contextLength,
        ...
        super(contextLength, embeddingLength, hiddenLength, numberOfHeads, numberOfKeyValueHeads, numberOfLayers, layerNormEps, vocabularySize, bosToken, eosToken, 10000.0);
    }
}
