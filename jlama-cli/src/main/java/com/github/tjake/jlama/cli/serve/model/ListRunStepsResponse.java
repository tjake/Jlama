...
import com.github.tjake.jlama.cli.serve.model.RunStepObject;
...
public class ListRunStepsResponse   {
  ...
  private @Valid List<@Valid RunStepObject> data = new ArrayList<>();
  ...
  public ListRunStepsResponse removeDataItem(RunStepObject dataItem) {
  ...
  @ApiModelProperty(example = "step_hLBK7PXBv5Lr2NQT7KLY0ag1", required = true, value = "")
  ...
  @ApiModelProperty(example = "step_QLoItBbqwyAJEzlTy4y9kOMM", required = true, value = "")
