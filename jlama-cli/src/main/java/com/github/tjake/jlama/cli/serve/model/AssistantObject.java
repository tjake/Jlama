...
public class AssistantObject   {
 ...
 @Size(max=512)  public String getDescription() {
  ...
  @ApiModelProperty(required = true, value = "model_description")
  @JsonProperty("model")
  @NotNull
  ...
  @ApiModelProperty(required = true, value = "The system instructions that the assistant uses. The maximum length is 32768 characters. ")
 ...
 @Size(max=20)  public List<String> getFileIds() {
  ...
  public AssistantObject removeFileIdsItem(String fileIdsItem) {
