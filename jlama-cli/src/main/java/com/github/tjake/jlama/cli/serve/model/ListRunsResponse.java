...
import com.github.tjake.jlama.cli.serve.model.RunObject;
...
public class ListRunsResponse   {
  ...
  @ApiModelProperty(example = "run_hLBK7PXBv5Lr2NQT7KLY0ag1", required = true, value = "")
  ...
  @ApiModelProperty(example = "run_QLoItBbqwyAJEzlTy4y9kOMM", required = true, value = "")
